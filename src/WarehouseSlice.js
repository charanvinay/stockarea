...
const WarehouseSlice = createSlice({
  ...
  reducers: {
    ...
    warehouseUpdated(state, action) {
      ...
      const existingWarehouse = state.find((user) => user.id === id);
      if (existingWarehouse) {
        existingWarehouse.name = name;
        existingWarehouse.code = code;
        existingWarehouse.space_available = spaceAvailable;
        existingWarehouse.type = type;
        existingWarehouse.cluster = cluster;
        existingWarehouse.is_registered = isRegistered;
        existingWarehouse.is_live = isLive;
...
export const { warehouseAdded, warehouseUpdated } = WarehouseSlice.actions;
